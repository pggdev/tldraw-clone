...
export const Login = ({ socket, LoginisOpen, setLoginisOpen }: { socket?: WebSocket | null, LoginisOpen: boolean, setLoginisOpen: Dispatch<SetStateAction<boolean>> }) => {
    ...
    return <div className="">
        ...
        {LoginisOpen && <div className="h-screen w-screen absolute inset-0 z-50 backdrop-blur-sm flex justify-center items-center">

            <div className="p-5 py-10 bg-white rounded-lg relative">

                <button className=" absolute right-5 top-5 p-1 " onClick={() => setLoginisOpen(false)}> <IconX className="size-4" /></button>
        ...
        <CustomBtn onClick={() => setLoginisOpen(true)}>Login</CustomBtn>
